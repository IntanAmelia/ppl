        ...
        <main class="main">
            ...
            <form id="form-login" action="" method="POST">
                ...
                <div class="submit-button input-field">
                    <button type="submit" name="add-product" id="add-product" onclick="return confirm('yakin data produk sudah benar?');">Masukkan Keranjang</button>
                </div>
                <div class="submit-button input-field">
                    <a class="tombol-batal" href="keranjang.php" onclick="return confirm('yakin batal edit produk yang akan dibeli?');">Batal</a>
                </div>
            </form>
        </main>
    </section>
